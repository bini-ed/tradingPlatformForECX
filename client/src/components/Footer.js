    ...
    <div className="bg-[#DEF2E6] flex flex-col items-center justify-evenly min-h-[300px] py-[20px] relative">
      <div className="flex flex-col md:flex-row justify-evenly">
        <div className="w-full md:w-[25%] flex flex-col justify-start items-start">
          ...
          <p className="w-[100%] text-left mt-8 space-y-1 text-sm text-black-700">
            ECX assures all commodity market players the security they need in
            the market through providing a secure and reliable End-to-End system
            for handling, grading, and storing commodities, matching offers and
            bids for commodity transactions, and a risk-free payment and goods
            delivery system to settle transactions, while serving all fairly and
            efficiently. ECX creates trust and transparency through aggressive
            market data dissemination to all market actors, through clearly
            defined rules of trading, warehousing, payments and delivery and
        ...
        <div>
          <p className="text-[green] font-semibold">Socials</p>
        ...
        <div className="w-full md:w-[25%]">
          ...
          <p className="w-[100%]">Coffee</p>
          <p className="w-[100%]">Maize</p>
          <p className="w-[100%]">Wheat</p>
          <p className="w-[100%]">Seaseme</p>
        </div>
      </div>

      <p class="mt-8 text-xs text-gray-500 sm:mt-2">
        &copy; {date.getFullYear()}. ECX. All rights reserved.
      </p>
    </div>
  );
});
